---
name: revision
description: "Cross-review an already-drafted PRD.md and SPEC.md pair to catch gaps, inconsistencies, and mismatches before implementation. Use when the user wants to revise, cross-check, or sanity-check paired PRD and SPEC documents, resolve contradictions between them, or invokes /revision. Composite pass covering cross-doc alignment, internal coherence, adversarial premise challenge, and scope creep. Produces docs/YYYY-MM-DD-slug/REVISION.md and, on explicit user approval, patches both PRD.md and SPEC.md with a dated Revision section. Strictly gated: no edits to PRD.md or SPEC.md without explicit user approval."
