...
**Eleven composable, scope-adaptive Claude Code skills for compound engineering —
reverse-engineer, plan, diagnose, audit, execute, review, triage PR feedback, ship, and remember.**

[![License: MIT](https://img.shields.io/badge/license-MIT-blue)](LICENSE)
[![Version 0.11.0](https://img.shields.io/badge/version-0.11.0-brightgreen)](.claude-plugin/plugin.json)
...
A Claude Code plugin with eleven sharp, composable skills:
...
## How `teardown`, `prd`, `spec`, `revision`, `diagnosis`, `audit`, `execute`, `code-review`, `pr-feedback`, `commit-push`, and `solutions` compose
